/* ================================================================================================
Purpose:
    Disables all foreign key constraints, check constraints and triggers.
...
/*
    foreign keys and check constraints
     ...
     - work through the cursor to build and execute a statement that disables each
*/
...
BEGIN
    SET @sql_cmd = N'ALTER TABLE ' + @table_schema + N'.' + @table_name + N' NOCHECK CONSTRAINT ' + @constraint_name + N';';
...
WHILE ( @@fetch_status = 0 )
BEGIN
    SET @sql_cmd = N'ALTER TABLE ' + @table_schema + N'.' + @table_name + N' DISABLE TRIGGER ' + @trigger_name + N';';
