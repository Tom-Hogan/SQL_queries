                    ...
                    OR   s2.freq_type = 0x1
                        THEN ' at ' +   CASE
                                            ...
                                            WHEN (s2.active_start_time % 1000000) / 10000 < 12
                                                THEN cast((s2.active_start_time % 1000000) / 10000 AS varchar(2)) + ':' + right('00' + cast((s2.active_start_time % 10000) / 100 AS varchar(2)), 2) + 'am'
                                            WHEN (s2.active_start_time % 1000000) / 10000 = 12
                                                THEN cast((s2.active_start_time % 1000000) / 10000 AS varchar(2)) + ':' + right('00' + cast((s2.active_start_time % 10000) / 100 AS varchar(2)), 2) + 'pm'
                                            ELSE cast(((s2.active_start_time % 1000000) / 10000) - 12 AS varchar(2)) + ':' + right('00' + cast((s2.active_start_time % 10000) / 100 AS varchar(2)), 2) + 'pm'
                                        END
                    --   intervals
                        ...
                        THEN ' between '
                            ...
                            +   CASE
                                    ...
                                    WHEN (s2.active_end_time % 1000000) / 10000 < 12
                                        THEN cast((s2.active_end_time % 1000000) / 10000 AS varchar(2)) + ':' + right('00' + cast((s2.active_end_time % 10000) / 100 AS varchar(2)), 2) + 'am'
                                    WHEN (s2.active_end_time % 1000000) / 10000 = 12
                                        THEN cast((s2.active_end_time % 1000000) / 10000 AS varchar(2)) + ':' + right('00' + cast((s2.active_end_time % 10000) / 100 AS varchar(2)), 2) + 'pm'
                                    ELSE cast(((s2.active_end_time % 1000000) / 10000) - 12 AS varchar(2)) + ':' + right('00' + cast((s2.active_end_time % 10000) / 100 AS varchar(2)), 2) + 'pm'
                            END
                    ELSE ''
